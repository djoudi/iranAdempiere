...
import org.adempiere.jbpm.Actor;
...
*/
	...
	private void addJBPMActor() {
		Actor actor = Actor.getInstance();
		Properties ctx = Env.getCtx();
		actor.setId(Env.getContext(ctx, "#AD_User_Name"));
		actor.getGroupActorIds().add(Env.getContext(ctx, "#AD_Role_Name"));
		log.info("Add jbpm Actor : " + actor.getId());
	}
