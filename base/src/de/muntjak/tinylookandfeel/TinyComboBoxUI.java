 ...
 * @author Hans Bickel
 */
public class TinyComboBoxUI extends MotifComboBoxUI {
			...
			if (comboBox.isEditable()) {
				if (arrowButton != null) {
					arrowButton.setBounds(width -
						Theme.comboButtonWidth[Theme.derivedStyle[Theme.style]], 0,
						Theme.comboButtonWidth[Theme.derivedStyle[Theme.style]], height);
				}
				if (editor != null) {
...
// * @author Hans Bickel
// */
//public class TinyComboBoxUI extends MetalComboBoxUI {
//	
//	
//
//	public static ComponentUI createUI(JComponent c) {
...
//	protected ComboPopup createPopup()
//	{
//		TinyComboPopup newPopup = new TinyComboPopup( comboBox );
