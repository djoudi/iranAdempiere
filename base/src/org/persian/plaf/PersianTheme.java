 ...
 * 
 */
public class PersianTheme extends de.muntjak.tinylookandfeel.TinyDefaultTheme {
	...
	/** Static Initializer */
	static {
		s_theme = new org.persian.plaf.PersianTheme();
	}
	/** Theme Name */
	protected static String s_name = "TinyLaF Default Theme";
	public static final String NAME = s_name;

	/** Active Theme */
	protected static PersianTheme s_theme = null;
	...
	/** Gray 102, 102, 102 */
	public static ColorUIResource secondary1 = new ColorUIResource(190, 179,
			153);
	/** Gray 153, 153, 153 */
	public static ColorUIResource secondary2 = new ColorUIResource(196, 189,
			174);
	/** BlueGray 214, 224, 234 - background */
	public static ColorUIResource secondary3 = new ColorUIResource(251, 248,
			241);
	/** White */
	public final ColorUIResource secondary4 = new ColorUIResource(255, 255, 255);

	/** Black */
	public static ColorUIResource black = TinyLookAndFeel.getBlack();
	/** White */
	public static ColorUIResource white = TinyLookAndFeel.getWhite();

	/** Background for mandatory fields */
	// public static ColorUIResource mandatory = new ColorUIResource(233, 238,
	// 245); // blueish
	public static ColorUIResource mandatory = new ColorUIResource(205, 225, 245); // BF[
																					// 1640919
																					// ]
																					// Adempiere
																					// Theme
	...
	public static ColorUIResource inactive = new ColorUIResource(241, 239, 222); // 234,
																					// 234,
																					// 234);
	/** Background for info fields */
	public static ColorUIResource info = new ColorUIResource(251, 248, 251); // somewhat
																				// white
	...
	/** Default Font */
	public static final String FONT_DEFAULT = "Tahoma";
	/** Default Font Size */
	...
	public ColorUIResource getBlack() {
		...
		return ColorBlind.getDichromatColorUIResource(TinyLookAndFeel
				.getBlack());
	}
		...
		if (controlFont == null) {
			try {
				controlFont = new FontUIResource(Font.getFont(
						"swing.plaf.metal.controlFont", new Font(FONT_DEFAULT,
								Font.PLAIN, FONT_SIZE)));
			} catch (Exception e) {
				controlFont = new FontUIResource(FONT_DEFAULT, Font.PLAIN,
						FONT_SIZE);
			}
		}
		return controlFont;
		...
		if (systemFont == null) {
			try {
				systemFont = new FontUIResource(Font.getFont(
						"swing.plaf.metal.systemFont", new Font(FONT_DEFAULT,
								Font.PLAIN, FONT_SIZE)));
			} catch (Exception e) {
				systemFont = new FontUIResource(FONT_DEFAULT, Font.PLAIN,
						FONT_SIZE);
			}
		}
		return systemFont;
		...
		if (userFont == null) {
			try {
				userFont = new FontUIResource(Font.getFont(
						"swing.plaf.metal.userFont", new Font(FONT_DEFAULT,
								Font.PLAIN, FONT_SIZE)));
			} catch (Exception e) {
				userFont = new FontUIResource(FONT_DEFAULT, Font.PLAIN,
						FONT_SIZE);
			}
		}
		return userFont;
	...
	protected static FontUIResource _getMenuTextFont() {
		if (menuFont == null) {
			try {
				menuFont = new FontUIResource(Font.getFont(
						"swing.plaf.metal.menuFont", new Font(FONT_DEFAULT,
								Font.PLAIN, FONT_SIZE)));
			} catch (Exception e) {
				menuFont = new FontUIResource(FONT_DEFAULT, Font.PLAIN,
						FONT_SIZE);
			}
		}
		return menuFont;
	...
	protected static FontUIResource _getWindowTitleFont() {
		if (windowFont == null) {
			try {
				windowFont = new FontUIResource(Font.getFont(
						"swing.plaf.metal.windowFont", new Font(FONT_DEFAULT,
								Font.BOLD, FONT_SIZE + 2)));
			} catch (Exception e) {
				windowFont = new FontUIResource(FONT_DEFAULT, Font.BOLD,
						FONT_SIZE + 2);
			}
		}
		return windowFont;
		...
		if (smallFont == null) {
			try {
				smallFont = new FontUIResource(Font.getFont(
						"swing.plaf.metal.smallFont", new Font(FONT_DEFAULT,
								Font.PLAIN, FONT_SIZE - 2)));
			} catch (Exception e) {
				smallFont = new FontUIResource(FONT_DEFAULT, Font.PLAIN,
						FONT_SIZE - 2);
			}
		}
		return smallFont;
	...
	/**
	 * Parses Color into String representation. Required as SystemColors and
	 * Alpha Colors have different formats
	 * 
	 * @param c
	 *            Color
	...
	public static String getColorAsString(Color c) {
		...
		StringBuffer sb = new StringBuffer("[r=").append(c.getRed())
				.append(",g=").append(c.getGreen()).append(",b=")
				.append(c.getBlue()).append(",a=").append(c.getAlpha())
				.append("]");
	...
	public ColorUIResource getMenuSelectedForeground() {
		return TinyLookAndFeel.getWhite();
	}
	...
	public void addCustomEntriesToTable(UIDefaults table) {
		...
		Object[] uiDefaults = { ExtendedTheme.ERROR_BG_KEY, error,
				ExtendedTheme.ERROR_FG_KEY, txt_error,
				ExtendedTheme.INACTIVE_BG_KEY, inactive,
				ExtendedTheme.INFO_BG_KEY, info,
				ExtendedTheme.MANDATORY_BG_KEY, mandatory };
