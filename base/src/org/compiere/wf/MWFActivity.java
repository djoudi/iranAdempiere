...
import org.adempiere.jbpm.ManagedJbpmContext;
...
public class MWFActivity extends X_AD_WF_Activity implements Runnable
{
	...
	private boolean performWork (Trx trx) throws Exception
	{
		...
		*/
		...
		/******	JBPM						******/
		else if(MWFNode.ACTION_JBPMNODE.equals(action)){
			ManagedJbpmContext managedJbpm = new ManagedJbpmContext();
			managedJbpm.installProcessDefinitions(new String[]{"org/adempiere/jbpm/test.jpdl.xml"});
			managedJbpm.createProcess("test", true);
			return false;
		}
		//
